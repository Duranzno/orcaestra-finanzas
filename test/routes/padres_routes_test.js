...
describe(addr, function(){
  ...
  xit(`PUT ${addr}/:id` ,async function() {
    try{
    await Estudiante.deleteMany({});
  ...
  xit(`DELETE ${addr}/:id`,async function(){
  ...
  xit(`POST ${addr}/:id/pago`,async function() {
    await Pago.deleteMany({});
