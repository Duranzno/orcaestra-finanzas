...
!(function(e, t) {
  ...
  for (
      ...
      (N = (function() {
        ...
        return (
          (e.toggle = function() {
            var e = !0;
            var t = !0;
            var n = m(this._element).closest(S)[0];
            if (n) {
      ...
      (re = (function() {
        ...
        return (
          ...
          (e._slide = function(e, t) {
            ...
            var l = t || (s && this._getItemByDirection(e, s));
      ...
      (be = (function() {
        function a(t, e) {
          ...
          for (
            ...
            var o = n[i];
            var s = we.getSelectorFromElement(o);
            var a = [].slice
        ...
        return (
          ...
          (e.show = function() {
            ...
            if (
              ...
              if ((oe(this._element).trigger(i), !i.isDefaultPrevented())) {
                ...
                var s = we.getTransitionDurationFromElement(this._element);
                oe(this._element)
                  .one(we.TRANSITION_END, function() {
                    oe(n._element)
                      .removeClass(me)
          ...
          (a._jQueryInterface = function(i) {
            return this.each(function() {
              var e = oe(this);
              var t = e.data(ae);
              var n = l({}, ue, e.data(), typeof i === 'object' && i ? i : {});
              if (
    ...
    if (Ae && navigator.userAgent.indexOf(Ie[Ne]) >= 0) {
      Oe = 1;
      break;
    }
  var ke =
  ...
  var Me = Ae && /MSIE 10/.test(navigator.userAgent);
  function Fe(e) {
    return e === 11 ? He : e === 10 ? Me : He || Me;
  }
  function We(e) {
  ...
  function Re(e) {
    return e.parentNode !== null ? Re(e.parentNode) : e;
  }
  function Ue(e, t) {
    ...
    if ((e !== l && t !== l) || i.contains(r))
      return (a = (s = l).nodeName) === 'BODY' ||
        (a !== 'HTML' && We(s.firstElementChild) !== s)
        ? We(l)
        : l;
    var c = Re(e);
  ...
  function Qe() {
    ...
    var n = Fe(10) && getComputedStyle(t);
  ...
  function Je(e) {
    ...
    var o = e.nodeName === 'HTML' ? Qe() : {};
    var s = o.width || e.clientWidth || r.right - r.left;
    var a = o.height || e.clientHeight || r.bottom - r.top;
    var l = e.offsetWidth - s;
    var c = e.offsetHeight - a;
    if (l || c) {
      var u = Pe(e);
  ...
  function Ze(e, t) {
    ...
    var u = parseFloat(l.borderLeftWidth, 10);
    n &&
      t.nodeName === 'HTML' &&
    ...
    return (
      (i && !n ? t.contains(a) : t === a && a.nodeName !== 'BODY') &&
        (f = (function(e, t) {
          var n =
  ...
  function Xe(e) {
    ...
    for (var t = e.parentElement; t && Pe(t, 'transform') === 'none'; )
      t = t.parentElement;
  ...
  function $e(e, t, n, i) {
    ...
    if (i === 'viewport')
      ...
      var a = void 0;
      i === 'scrollParent'
        ? (a = je(Le(t))).nodeName === 'BODY' &&
          (a = e.ownerDocument.documentElement)
        : (a = i === 'window' ? e.ownerDocument.documentElement : i);
      var l = Ze(a, s, r);
      if (
        a.nodeName !== 'HTML' ||
        (function e(t) {
  ...
  function ut(e, t, n, i) {
    ...
    return (
      (function e(t, n, i, r) {
        ...
        var s = o ? t.ownerDocument.defaultView : t;
  ...
  function _t(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
    var n = gt.indexOf(e);
    var i = gt.slice(n + 1).concat(gt.slice(0, n));
    return t ? i.reverse() : i;
  }
  var vt = 'flip';
  var yt = 'clockwise';
  var Et = 'counterclockwise';
  function bt(e, r, o, t) {
    var s = [0, 0];
    var a = ['right', 'left'].indexOf(t) !== -1;
    ...
    modifiers: {
      ...
      arrow: {
        ...
        fn: function(e, t) {
          ...
          var m = a[f] + a[c] / 2 - p / 2;
          var g = Pe(e.instance.popper);
          var _ = parseFloat(g['margin' + u], 10);
          var v = parseFloat(g['border' + u + 'Width'], 10);
          var y = m - e.offsets.popper[f] - _ - v;
          return (
        ...
        fn: function(p, m) {
          ...
          return (
            E.forEach(function(e, t) {
              ...
              var a = o(i.left) < o(g.left);
              var l = o(i.right) > o(g.right);
              var c = o(i.top) < o(g.top);
              var u = o(i.bottom) > o(g.bottom);
              var f =
                (_ === 'left' && a) ||
                (_ === 'right' && l) ||
                (_ === 'top' && c) ||
                (_ === 'bottom' && u);
              var h = ['top', 'bottom'].indexOf(_) !== -1;
              var d =
                !!m.flipVariations &&
                ((h && y === 'start' && a) ||
                  (h && y === 'end' && l) ||
      ...
      hide: {
        ...
        fn: function(e) {
          ...
          var n = ot(e.instance.modifiers, function(e) {
      ...
      computeStyle: {
        ...
        fn: function(e, t) {
          ...
          var o = ot(e.instance.modifiers, function(e) {
          ...
          var u = n === 'bottom' ? 'top' : 'bottom';
          var f = i === 'right' ? 'left' : 'right';
          var h = lt('transform');
          var d = void 0;
          var p = void 0;
          if (
            ((p = u === 'bottom' ? -a.height + c.bottom : c.top),
            (d = f === 'right' ? -a.width + c.right : c.left),
            s && h)
          )
  ...
  var Ct = (function() {
    function o(e, t) {
      ...
      !(function(e, t) {
        ...
        Object.keys(ze({}, o.Defaults.modifiers, i.modifiers)).forEach(function(
          e
        ) {
  ...
  (Ct.Utils = (typeof window !== 'undefined' ? window : global).PopperUtils),
    (Ct.placements = mt),
    (Ct.Defaults = wt);
  var Tt;
  var St;
    ...
    return (
      (e.toggle = function() {
        if (!this._element.disabled && !Tt(this._element).hasClass(xt)) {
          ...
          var t = Tt(this._menu).hasClass(Pt);
          if ((c._clearMenus(), !t)) {
            var n = {relatedTarget: this._element};
            var i = Tt.Event(kt.SHOW, n);
      ...
      (e._detectNavbar = function() {
        return Tt(this._element).closest('.navbar').length > 0;
      }),
      ...
      (c._clearMenus = function(e) {
        if (!e || (e.which !== 3 && (e.type !== 'keyup' || e.which === 9)))
          for (
            ...
            var o = Tt(t[n]).data(Dt);
            var s = {relatedTarget: t[n]};
            if ((e && e.type === 'click' && (s.clickEvent = e), o)) {
              var a = o._menu;
              if (
                Tt(r).hasClass(Pt) &&
                !(
      ...
      (c._getParentFromElement = function(e) {
        var t;
        var n = we.getSelectorFromElement(e);
      ...
      (c._dataApiKeydownHandler = function(e) {
        if (
          ...
          var n = Tt(t).hasClass(Pt);
          if (
            (n || (e.which === 27 && e.which === 32)) &&
            (!n || (e.which !== 27 && e.which !== 32))
          ) {
  ...
  (vn = (function() {
    ...
    return (
      ...
      (e._showElement = function(e) {
        var t = this;
        var n = $t(this._element).hasClass(fn);
      ...
      (e._enforceFocus = function() {
        ...
        $t(document)
          ...
          .on(an.FOCUSIN, function(e) {
            document !== e.target &&
              t._element !== e.target &&
              $t(t._element).has(e.target).length === 0 &&
              t._element.focus();
          });
      }),
      ...
      (e._showBackdrop = function(e) {
        var t = this;
        var n = $t(this._element).hasClass(fn) ? fn : '';
  ...
  $t(document).on(an.CLICK_DATA_API, pn, function(e) {
    var t;
    var n = this;
    var i = we.getSelectorFromElement(this);
  ...
  (Rn = (function() {
    ...
    return (
      ...
      (e.toggle = function(e) {
        if (this._isEnabled)
          if (e) {
            ...
            var n = yn(e.currentTarget).data(t);
            n ||
      ...
      (e.show = function() {
        var t = this;
        if (yn(this.element).css('display') === 'none')
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          var r = we.getUID(this.constructor.NAME);
          i.setAttribute('id', r),
      ...
      (e.hide = function(e) {
        ...
        var i = yn.Event(this.constructor.Event.HIDE);
        var r = function() {
      ...
      (e._enter = function(e, t) {
        ...
        (t = t || yn(e.currentTarget).data(n)) ||
          ...
          e && (t._activeTrigger[e.type === 'focusin' ? Mn : Hn] = !0),
      ...
      (e._leave = function(e, t) {
        ...
        (t = t || yn(e.currentTarget).data(n)) ||
          ...
          yn(e.currentTarget).data(n, t)),
          e && (t._activeTrigger[e.type === 'focusout' ? Mn : Hn] = !1),
      ...
      (e._getConfig = function(e) {
        return (
          typeof (e = l(
            ...
            typeof e === 'object' && e ? e : {}
          )).delay === 'number' && (e.delay = {show: e.delay, hide: e.delay}),
  ...
  (Ci = (function() {
    ...
    return (
      (e.refresh = function() {
        var t = this;
        var e = this._scrollElement === this._scrollElement.window ? bi : wi;
        var r = this._config.method === 'auto' ? e : this._config.method;
        var o = r === wi ? this._getScrollTop() : 0;
        (this._offsets = []),
          (this._targets = []),
      ...
      (e._getConfig = function(e) {
        if (
          typeof (e = l({}, ai, typeof e === 'object' && e ? e : {})).target !==
          'string'
        ) {
    ...
    return (
      (e.show = function() {
        ...
        if (
          ...
          var e;
          var i;
          var t = Ti(this._element).closest(ji)[0];
          var r = we.getSelectorFromElement(this._element);
          if (t) {
            var o = t.nodeName === 'UL' ? Mi : Hi;
            i = (i = Ti.makeArray(Ti(t).find(o)))[i.length - 1];
          }
          var s = Ti.Event(Ii.HIDE, {relatedTarget: this._element});
          var a = Ti.Event(Ii.SHOW, {relatedTarget: i});
          if (
            (i && Ti(i).trigger(s),
            ...
            var l = function() {
              ...
              var t = Ti.Event(Ii.SHOWN, {relatedTarget: i});
      ...
      (e._activate = function(e, t, n) {
        var i = this;
        var r = (t.nodeName === 'UL' ? Ti(t).find(Mi) : Ti(t).children(Hi))[0];
        var o = n && r && Ti(r).hasClass(xi);
        var s = function() {
      ...
      (i._jQueryInterface = function(n) {
        return this.each(function() {
          ...
          var t = e.data(Si);
          if (
            (t || ((t = new i(this)), e.data(Si, t)), typeof n === 'string')
          ) {
