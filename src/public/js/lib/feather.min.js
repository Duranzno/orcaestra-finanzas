...
*/
    ...
    function(e, n, i) {
      ...
      var c = function(e, n, i) {
        ...
        var f = e & c.P;
        var v = e & c.B;
        var g = u ? l : d ? l[n] || (l[n] = {}) : (l[n] || {}).prototype;
        var m = u ? t : t[n] || (t[n] = {});
        var M = m.prototype || (m.prototype = {});
        for (y in (u && (i = n), i))
    ...
    function(e, n, i) {
      ...
      var l;
      var t = i(8);
      var r = (l = t) && l.__esModule ? l : {default: l};
        ...
        return void 0 === e
          ...
          : e === null
            ...
            : typeof (i = (function(e, n) {
              ...
              : r
                ? l(n)
                : (o = l(n)) == 'Object' && typeof n.callee === 'function'
                  ? 'Arguments'
                  : o;
      };
    },
      ...
      t(
        ...
        'Array',
        {
          from: function(e) {
            ...
            var h;
            var x = r(e);
            var s = typeof this === 'function' ? this : Array;
            var u = arguments.length;
            var d = u > 1 ? arguments[1] : void 0;
            var f = void 0 !== d;
            var v = 0;
            var g = p(x);
            if (
    ...
    function(e, n, i) {
      ...
      e.exports = Object('z').propertyIsEnumerable(0)
        ? Object
        : function(e) {
            return l(e) == 'String' ? e.split('') : Object(e);
          };
    },
    function(e, n, i) {
      var l = i(2);
    ...
    function(e, n, i) {
      ...
      e.exports = function(e, n) {
        if (!l(e)) return e;
        var i, t;
        if (n && typeof (i = e.toString) === 'function' && !l((t = i.call(e))))
          return t;
        if (typeof (i = e.valueOf) === 'function' && !l((t = i.call(e))))
          return t;
        if (!n && typeof (i = e.toString) === 'function' && !l((t = i.call(e))))
          return t;
    ...
    function(e, n, i) {
      ...
      e.exports = function(e, n, i, d, f, v, g) {
        ...
        var k = !1;
        var H = e.prototype;
        var V = H[x] || H['@@iterator'] || (f && H[f]);
        var O = (!s && V) || b(f);
        var _ = f ? (A ? b('entries') : O) : void 0;
        var j = (n == 'Array' && H.entries) || V;
        if (
          (j &&
