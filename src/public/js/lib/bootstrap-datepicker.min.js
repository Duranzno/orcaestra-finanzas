...
!(function(a) {
  ...
  function h(b, c) {
    ...
    var f = a(b).data();
    var g = {};
    var h = new RegExp('^' + c.toLowerCase() + '([A-Z])');
  ...
  k.prototype = {
    ...
    _process_options: function(b) {
      ...
      var h = String(e.orientation)
        .toLowerCase()
        .split(/\s+/g);
      var i = e.orientation.toLowerCase();
      if (
      ...
      if (
        ...
        var k = e.defaultViewDate.month || 0;
    ...
    place: function() {
      ...
      var c = this.picker.outerHeight();
      var d = 10;
      var e = a(this.o.container);
      var f = e.width();
      var g =
      ...
      var k = this.component
        ? this.component.parent().offset()
        : this.element.offset();
      var l = this.component
        ? this.component.outerHeight(!0)
        : this.element.outerHeight(!1);
      var m = this.component
    ...
    getClassNames: function(b) {
      ...
      var g = this.viewDate.getUTCMonth();
      var h = d();
      return (
        b.getUTCFullYear() < f ||
    ...
    fill: function() {
      ...
      var m = q[this.o.language].today || q.en.today || '';
      var n = q[this.o.language].clear || q.en.clear || '';
      var o = q[this.o.language].titleFormat || q.en.titleFormat;
      if (!isNaN(g) && !isNaN(h)) {
        this.picker
        ...
        for (var u, v, w = []; p.valueOf() < t; ) {
          if (
            ...
            var y = new Date(Number(x) + ((11 - x.getUTCDay()) % 7) * 864e5);
            var z = new Date(
    ...
    updateNavArrows: function() {
      if (this._allow_update) {
        ...
        var h =
          this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0;
        var i = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0;
        var j = 1;
    ...
    keydown: function(a) {
      ...
      var c;
      var d = !1;
      var e = this.focusDate || this.viewDate;
      switch (a.keyCode) {
        case 27:
          this.focusDate
            ? ((this.focusDate = null),
  ...
  l.prototype = {
    ...
    dateUpdated: function(c) {
      if (!this.updating) {
        ...
        if (d !== b) {
          var e = d.getUTCDate();
          var f = this.keepEmptyValues;
          var g = a.inArray(c.target, this.inputs);
          var h = g - 1;
          var i = g + 1;
  ...
  var n = function(c) {
    ...
    if (
      (this.each(function() {
        var b = a(this);
        var f = b.data('datepicker');
        var g = typeof c === 'object' && c;
        if (!f) {
          var j = h(this, 'date');
          var m = a.extend({}, o, j, g);
          var n = i(m.language);
          var p = a.extend({}, o, n, j, g);
  ...
  var r = {
    ...
    parseDate: function(c, e, f, g) {
      ...
      var n;
      var o;
      var p = {d: 'moveDay', m: 'moveMonth', w: 'moveWeek', y: 'moveYear'};
      var s = {yesterday: '-1d', today: '+0d', tomorrow: '+1d'};
      if (
        (c in s && (c = s[c]),
