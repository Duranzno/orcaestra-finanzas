        ...
        {"data": "tlf"},
        {
            ...
            "render": function htmlModalPago(d, i) {
                return `<button type="button" data-toggle="modal" data-target="#estudianteModal" class="btn btn-edit-pago btn-sm" 
                        data-estudianteId="${d._id}" data-nombre="${d.nombre}" data-apellido="${d.apellido}" data-tlf="${d.tlf}" data-grupo="${d.grupo}"
                        data-email="${d.email}">
        ...
        $("#table tbody").on("click", "td.details-control", function () {
            ...
            function htmlFilaPago(d) {
                ...
                function htmlModalPago(d, i) {
                    return `<button type="button" data-toggle="modal" data-target="#pagoModal" class="btn btn-edit-pago btn-sm" data-pagoId="` + d.pagos[i]._id + `">` +
